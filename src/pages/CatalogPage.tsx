  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {lowCount > 0 && (
          <div className="flex items-center gap-2 rounded-lg border border-amber-300 bg-amber-100 px-4 py-2.5 dark:border-amber-800 dark:bg-amber-950/30">
        ...
        {outCount > 0 && (
          <div className="flex items-center gap-2 rounded-lg border border-rose-300 bg-rose-100 px-4 py-2.5 dark:border-rose-800 dark:bg-rose-950/30">
            ...
            <TableBody>
              {filtered.map((item) => (
                <TableRow
                  ...
                  className={
                    item.status === "out"
                      ? "bg-rose-100/50 dark:bg-rose-950/20"
                      : item.status === "low"
